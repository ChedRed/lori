...
[] lori.new.mesh(vertices: Vertex[]) -> lori.Shape
...
[] lori.new.object(x: float, y: float, r: float, shape: lori.Shape, collider: lori.Collider | None) -> lori.Object
...
```
lori.load() -> None
lori.keypressed(key) -> None
lori.keyreleased(key) -> None
lori.update() -> None
lori.render() -> None
```
